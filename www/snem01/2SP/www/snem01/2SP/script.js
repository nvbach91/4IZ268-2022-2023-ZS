$(document).ready(() => {
    ...
    async function loadFavorite() {
        ...
        const favorite = document.createElement('ul');
        ...
        for (let index = 0; index < favorites.length; index++) {
            ...
            favorite.appendChild(food);
            favorite.appendChild(buttonDelete);
            ...
            buttonDelete.addEventListener('click', function handleClick(event) {
                ...
                favorite.removeChild(food);
                favorite.removeChild(buttonDelete);
                console.log(favorites[index] + 'removed');
            });

        }
        foodFavorite.appendChild(favorite);
    }

    //used for display new items in favorites
    const butt = document.querySelector('.refresh');
    butt.addEventListener('click', function refresh() {
            ...
            ingredients.addEventListener('click', function handleClick(event) {
                ...
                switch (x) {
                    case 0:
                        ...
                        break;
                    case 1:
                        const last = ingredients.lastElementChild;
                        ingredients.removeChild(last);
                        break;
                }
                number++;
            });
