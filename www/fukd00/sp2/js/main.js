$(document).ready(() => {
    ...
    function createMixedCategoryBtn() {
    ...
    function finishQuiz() {
        ...
        $('#incorrAnsCount').append(AMOUNT_QUESTIONS - Number(sessionStorage.getItem('quizCorrectCount')));
        let quizPercent = 100 * Number(sessionStorage.getItem('quizCorrectCount')) / AMOUNT_QUESTIONS;
    ...
    function createMultipleAnswers(idx) {
    ...
    function createBooleanAnswers(idx) {
    ...
    function checkAnswer(param) {
        ...
        if (Number(sessionStorage.getItem('answeredCount')) === AMOUNT_QUESTIONS) {
            finishQuiz();
        }
    ...
    function incrIncorrectAnsCount() {
    ...
    function ansResultPopup(result) {
    ...
    function showNotEnoughQuestionsWarning() {
        let errorMsg = $('<div>',
            {
