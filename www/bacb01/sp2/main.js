(() => {
  ...
  let msgLocation = document.querySelector("#ntMsgLocation");
  ...
  let formValidation = () => {
    if (startTimeInput.value > endTimeInput.value) {
      ...
      startTimeInput.value = todaysDate;
    }
  ...
  function displayLoading() {
    msgLocation.classList.add("loader");
    setTimeout(() => {
      msgLocation.classList.remove("loader");
    }, 5000);
  }
