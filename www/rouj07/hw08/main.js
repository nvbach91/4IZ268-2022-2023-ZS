...
console.log('Pepemu je ' + (thisYear - birthYear) + ' let.')
...
console.log(celsius + '°C je ve Fahrenheitech ' + (((celsius * 9) / 5) + 32) + '°F.');
console.log(fahrenheit + '°F je ve stupních Celsia ' + (((fahrenheit - 32) * 5) / 9) + '°C.');
...
function pepesAge(birthYear) {
    console.log('Pepemu je ' + ((new Date().getFullYear()) - birthYear) + ' let.');
}

function temperatureConversion(celsius, fahrenheit) {
    console.log(celsius + '°C je ve Fahrenheitech ' + (((celsius * 9) / 5) + 32) + '°F.');
    console.log(fahrenheit + '°F je ve stupních Celsia ' + (((fahrenheit - 32) * 5) / 9) + '°C.');
}
