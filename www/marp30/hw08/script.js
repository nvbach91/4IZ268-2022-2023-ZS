...
createButton('task-3-2-1', 'Úloha 3-2-1 (Temperature conversion (20 °C to °F) - function)', celsiusToFahrenheit, 20);
createButton('task-3-2-1', 'Úloha 3-2-2 (Temperature conversion (70 °F to °C) - function)', fahrenheitToCelsius, 70);

/**
 * 4)  Vytvořte funkci, která vezme 2 číselné argumenty a vrátí podíl prvního čísla a druhého čísla. 
...
createButton('task-4-1', 'Úloha 4-1 (Proportion - 26, 37)', getProportion, 26, 37);
createButton('task-4-2', 'Úloha 4-2 (Proportion - 37, 26) - function)', getProportion, 37, 26);
createButton('task-4-3', 'Úloha 4-3 (Proportion - 37, 0) - function)', getProportion, 37, 0);
...
createButton('task-5-1', 'Úloha 5-1 (Number comparator)', compareNumbers, 15, 32);
createButton('task-5-2', 'Úloha 5-2 (Number comparator)', compareNumbers, 5.9, 6.1);
createButton('task-5-3', 'Úloha 5-3 (Number comparator)', compareNumbers, 100/ 5, 5 / 4);
